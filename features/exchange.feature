...
Scenario: Create a new exchange
    ...
    And I select wallet "AT Custom Pooled IFX 3329" in exchange
    And I open the destination wallets dropdown in exchange
    And I select destination wallet "AT Custom Pooled IFX 3331" in exchange
    ...
    And I should see the latest exchange transaction "Currency exchange 10.00 EUR to PLN" at current time
